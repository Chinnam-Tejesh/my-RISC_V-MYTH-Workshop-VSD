...
\TLV
   ...
   |cpu
      @0
         ...
         $pc[31:0] = ( >>1$reset) ? 32'b0 : >>1$taken_br ? >>1$br_tgt_pc : ( >>1$pc[31:0] + 32'd4);
      ...
      @1
         ...
         //$is_r_instr = ($instr[6:2] == 5'b01000) || ($instr[6:2] == 5'b01010) || ($instr[6:2] == 5'b01011) || ($instr[6:2] == 5'b10100);
         ...
         //Rf read
         //$rs1_valid = $rf_rd_en1 && !$reset && !$rf_wr_en;
         //$rs2_valid = $rf_rd_en2 && !$reset && !$rf_wr_en;
         ...
         //Rf write
         $rf_wr_en = $rd_valid && !$reset;
         $rd_not_zero = ($rd[4:0] == 5'd0) ? 1'b0 : 1'b1;
         $rf_wr_valid = $rd_valid && $rf_wr_en && $rd_not_zero;
         ?$rf_wr_valid
